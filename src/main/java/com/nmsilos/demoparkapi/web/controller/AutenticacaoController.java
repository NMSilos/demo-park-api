...
import com.nmsilos.demoparkapi.jwt.JwtToken;
import com.nmsilos.demoparkapi.jwt.JwtUserDetailsService;
import com.nmsilos.demoparkapi.web.dto.UsuarioLoginDto;
...
public class AutenticacaoController {
    ...
    public ResponseEntity<?> autenticar(@RequestBody @Valid UsuarioLoginDto dto, HttpServletRequest request) {
        log.info("Processo de autenticação do login {}", dto.getUsername());
        try {
